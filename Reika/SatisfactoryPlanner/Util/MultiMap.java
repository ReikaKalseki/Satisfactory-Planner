...
public final class MultiMap<K, V> {
	...
	public Collection<V> get(K key) {
		...
		if (c == null && nullEmpty)
			return null;
		return c != null ? (modifiable ? c : Collections.unmodifiableCollection(c)) : factory.createCollection(); //Internal NPE protection
	}
	...
	public boolean containsValue(V value) {
		return JavaUtil.collectionMapContainsValue(data, value);
	}
	...
	public boolean equals(Object o) {
		return o instanceof MultiMap && data.equals(((MultiMap)o).data);
	}
